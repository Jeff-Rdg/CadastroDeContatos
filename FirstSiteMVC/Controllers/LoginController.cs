    ...
    public class LoginController : Controller
    {
        ...
        public IActionResult Entrar(LoginModel loginModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    TempData["MensagemErro"] = $"Usuário ou senha inválido. Tente novamente.";
                }
                return View("Index");
            }
            catch (Exception erro)
            {
                ...
                TempData["MensagemErro"] = $"Não foi possivel Realizar seu login. Detalhe do erro: {erro.Message}";
        ...
        public IActionResult EnviarLinkParaRedefinirSenha(RedefinirSenhaModel redefinirSenhaModel)
        {
            ...
            catch (Exception erro)
            {
                ...
                TempData["MensagemErro"] = $"Não foi possivel redefinir sua senha, tente novamente. Detalhe do erro: {erro.Message}";
                return RedirectToAction("Index");
            }
        }
    }
